...
var tokensCss = i$3`:host{--ds-auro-alert-border-color: var(--ds-color-border-secondary-default, #939fad);--ds-auro-alert-container-color: var(--ds-color-container-primary-default, #ffffff);--ds-auro-alert-icon-color: transparent;--ds-auro-alert-text-color: var(--ds-color-text-primary-default, #2a2a2a)}`;
...
class AuroAlert extends AuroElement {
  ...
  generateIconHtml(category, name) {
    return this.noIcon
      ? u$1``
      : u$1`<${this.iconTag} customColor category="${category}" name="${name}"></${this.iconTag}>`;
