...
class AuroAlert extends AuroElement {
  ...
  generateIconHtml(category, name) {
    return this.noIcon
      ? ke``
      : ke`<${this.iconTag} customColor category="${category}" name="${name}"></${this.iconTag}>`;
